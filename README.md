...
1. Download or clone this [repostory](https://github.com/M-Anwar-Hussaini/Awesome-Library).
2. Provide a browser.
...
- Clone this [repository](https://github.com/M-Anwar-Hussaini/Awesome-Library.git) to your desired folder:

- Example commands:

```sh
  cd [YOUR FOLDER]
  git clone https://github.com/M-Anwar-Hussaini/Awesome-Library.git
```

### Install

- Install this project by cloning or downloading the master branch of this [repository](https://github.com/M-Anwar-Hussaini/Awesome-Library) and run `index.html` file on the root of repository.
